        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Note: Currently This All Books are freely Provided So Don't Use This payment Mode, please do not enter correct details!</h6>
            </div>
            <div class="card-body">
